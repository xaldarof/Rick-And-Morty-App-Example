...
public final class FragmentCharactersBinding implements ViewBinding {
  ...
  private FragmentCharactersBinding(@NonNull ConstraintLayout rootView,
      @NonNull ProgressBar progressView, @NonNull RecyclerView rv) {
  ...
  public static FragmentCharactersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCharactersBinding((ConstraintLayout) rootView, progressView, rv);
    }
