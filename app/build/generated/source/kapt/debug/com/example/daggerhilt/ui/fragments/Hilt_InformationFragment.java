...
public abstract class Hilt_InformationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InformationFragment() {
    super();
  }

  Hilt_InformationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InformationFragment_GeneratedInjector) this.generatedComponent()).injectInformationFragment(UnsafeCasts.<InformationFragment>unsafeCast(this));
    }
  }
